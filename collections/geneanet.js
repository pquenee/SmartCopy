...
//jobs
var jobs = "";
//console.log("Jobs",parsed.find(".row.clearfix + + +").html());
...
function parseGeneanetDate(vitalstring, type) {
  //console.log("Test fonctionnel avant   : ",vitalstring);
  ...
  console.log("Test fonctionnel après  : ",vitalstring);
  // Example matches:
  // in 1675
  // about 1675
  // before 1675
...
//                                                  modif ici (,)   
  ...
  if (exists(matches)) {
    ...
    if (dateval.startsWith("in ")) {
      //console.log("dateval ",dateval.match((/\d{4,}/)));
